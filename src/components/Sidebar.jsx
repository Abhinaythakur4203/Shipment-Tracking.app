...
export const Sidebar = () => {
    ...
    return (
        <>
            <div className='flex flex-col w-full h-screen  bg-gradient-to-br from-slate-700 to-gray-900 dark:bg-main-dark-bg'>
                ...
                <nav className=' sidenav flex flex-col p-4 space-y-2'>
                    {navItems.map((item, index) => (
                        <NavLink
                            ...
                            to={item.href}
                            className={({ isActive }) =>
                                `flex items-center p-2 text-white rounded-md hover:bg-gray-700 ${isActive ? 'bg-gray-700' : ''
                                }`
                            }
                        >
